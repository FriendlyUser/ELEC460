...
%% Initialization
function rhTable = RouthHurwitz(polyVector)
% clear ; close all; clc

% Using a combination of sympoly and then passing the input to this
% function, polyVector is a polynomial in the form of a vector
% Taking coefficients vector and organizing the first two rows
%coeffVector = input('input vector of your system coefficients: \n i.e. [an an-1 an-2 ... a0] = ');
coeffVector = polyVector;
